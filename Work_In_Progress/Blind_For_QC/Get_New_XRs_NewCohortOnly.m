function [dcmdir_out,final_ID_unblinded]=Get_New_XRs_NewCohortOnly(datedir_in)
% [dcmdir_out]=Get_New_XRs_NewCohortOnly;
...
% filter for MOST IDs for New Cohort only
mostid_x = indcfind(dicom_unblinded(:,3),'(MB|MI)(0|5)[3-9][0-9]{3}','regexpi');
oldmostid_x = indcfind(dicom_unblinded(:,3),'(MB|MI)(0|5)[0-2][0-9]{3}','regexpi');
id_mismatch_x = setdiff(setdiff([1:size(dicom_unblinded,1)],mostid_x),oldmostid_x);
